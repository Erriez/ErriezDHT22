...
platformio ci --lib="." --board uno --board micro --board nanoatmega328 --board pro16MHzatmega328 --board pro8MHzatmega328 --board leonardo examples/DHT22LowPower/DHT22LowPower.ino
